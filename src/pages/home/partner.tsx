      ...
      <div className="container text-center lg:text-left">
        <div className="grid lg:grid-cols-2 mb-12 lg:mb-16">
          <div className="col-span-1">
            <h2 className="text-3xl lg:text-4xl text-primary-dark-blue pb-5">Why choose Easybank?</h2>
        ...
        <div className="grid grid-cols-1 gap-9 lg:gap-6 lg:grid-cols-4">
          {partnerItems.map(item => (
            <div key={item.title} className="justify-center">
              ...
              <p className="text-neutral-grayish-blue text-sm font-light lg:text-base leading-5">{item.subtitle}</p>
            </div>
          ))}
        </div>
      </div>
