...
const routeList: RouteObject[] = [
  ...
  {
    path: '',
    element: <WrapperRouteComponent element={<LandingPage />} titleId="" />,
    children: [
      {
        path: '/',
  ...
  {
    path: '/',
    element: <WrapperRouteComponent element={<LayoutPage auth />} titleId="" auth />,
    children: [
      {
        path: 'dashboard',
      ...
      },
      {
        ...
        element: <WrapperRouteComponent element={<RoutePermission />} titleId="title.permission.route" admin />,
      },
      {
        path: 'component/form',
